...
using smtsharp.Expressions.FloatingPoint;
...
using Const = smtsharp.Expressions.Logic.Const;
 ...
 *------------------------------------------------------------------------*/
	...
	void FPExpr(out IExpression<FloatingPoint> expression) {
		expression = null; 
		Expr(out var expr);
		if (expr is IExpression<FloatingPoint> fpExpr) 
		expression = fpExpr; 
		else 
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 7: s = "\"declare-fun\" expected"; break;
			case 8: s = "\")\" expected"; break;
			case 9: s = "\"assert\" expected"; break;
			case 10: s = "\"set-logic\" expected"; break;
			case 11: s = "\"set-option\" expected"; break;
			case 12: s = "\"push\" expected"; break;
			case 13: s = "\"pop\" expected"; break;
			case 14: s = "\"reset\" expected"; break;
			case 15: s = "\"check-sat\" expected"; break;
			case 16: s = "\"get-model\" expected"; break;
			...
			case 27: s = "\"fp.isZero\" expected"; break;
			case 28: s = "\"extract\" expected"; break;
			case 29: s = "\"sign_extend\" expected"; break;
			case 30: s = "\"zero_extend\" expected"; break;
			case 31: s = "\"=>\" expected"; break;
			case 32: s = "\"bvand\" expected"; break;
			case 33: s = "\"bvor\" expected"; break;
			case 34: s = "\"bvxor\" expected"; break;
			case 35: s = "\"bvadd\" expected"; break;
			case 36: s = "\"bvmul\" expected"; break;
			case 37: s = "\"bvsdiv\" expected"; break;
			case 38: s = "\"bvudiv\" expected"; break;
			case 39: s = "\"bvsrem\" expected"; break;
			case 40: s = "\"bvurem\" expected"; break;
			case 41: s = "\"bvshl\" expected"; break;
			case 42: s = "\"bvlshr\" expected"; break;
			case 43: s = "\"bvslt\" expected"; break;
			case 44: s = "\"bvsle\" expected"; break;
			case 45: s = "\"bvsgt\" expected"; break;
			case 46: s = "\"bvsge\" expected"; break;
			case 47: s = "\"bvult\" expected"; break;
			case 48: s = "\"bvule\" expected"; break;
			case 49: s = "\"bvugt\" expected"; break;
			...
			case 66: s = "invalid VariadicExpr"; break;
